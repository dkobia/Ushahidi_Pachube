<div class="bg">
	...
	<div class="tabs">
		...
		<ul class="tabset">
			...
			<li><a href="<?php echo URL::site().'admin/pachube/discover'; ?>">Discover</a></li>
		</ul>
		<!-- tab -->
		<div class="tab" id="addedit">
			...
			<div class="tab_form_item">
				...
				<?php print form::input('feed', $form['feed'], ' class="text"'); ?>
			</div>					
			<div class="tab_form_item">
				&nbsp;<br />
									...
									<?php foreach($feed->pachube_datastream as $datastream): ?>
										<div class="feed_triggers">
											<?php print form::open(NULL,array('name' => 'pachubeFormTrigger')); ?>
												...
												<select name="trigger_type_<?php echo $datastream->datastream_id; ?>" id="trigger_type_<?php echo $datastream->datastream_id; ?>">
												...
												<?php print form::input('trigger_value_'.$datastream->datastream_id, ''); ?> 
												post a report to 
												<select name="category_<?php echo $datastream->datastream_id; ?>" id="category_<?php echo $datastream->datastream_id; ?>">
													<?php foreach ($categories as $category): ?>
														<option value="<?php echo $category->id; ?>"><?php echo $category->category_title; ?></option>
													<?php endforeach; ?>
												</select>
												<input type="button" value="Add" onclick="createTrigger(<?php echo $form->id.','.$datastream->datastream_id; ?>)">
											<?php print form::close(); ?>			
										</div>	
									<?php endforeach; ?>								
								</div>
